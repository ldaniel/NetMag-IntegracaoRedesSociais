...
namespace NetMag.RedesSociais.Notificador
{
    ...
    public class NotificationAreaIcon : FrameworkElement
    {
        ...
        public static readonly RoutedEvent MouseClickEvent = 
            ...
            "MouseClick", RoutingStrategy.Bubble, 
            typeof(MouseButtonEventHandler), 
            typeof(NotificationAreaIcon));

        public static readonly RoutedEvent MouseDoubleClickEvent = 
            EventManager.RegisterRoutedEvent(
            "MouseDoubleClick", RoutingStrategy.Bubble, 
            typeof(MouseButtonEventHandler), 
            typeof(NotificationAreaIcon));
        ...
        public static readonly DependencyProperty TextProperty =
            ...
            typeof(string), typeof(NotificationAreaIcon));

        public static readonly DependencyProperty FormsContextMenuProperty =
            DependencyProperty.Register("MenuItems", 
            typeof(List<Forms.MenuItem>), typeof(NotificationAreaIcon), 
            new PropertyMetadata(new List<Forms.MenuItem>()));
        ...
        protected override void OnInitialized(EventArgs e)
        {
            ...
            notifyIcon = new Forms.NotifyIcon {Text = Text};
